...
class Projetos(models.Model):
    ...
    descricaoLonga=models.TextField(null=True, blank=True, help_text="Use Markdown para formatação")
    ...
    descricaoBackEnd=models.TextField(blank=True, null=True, help_text="Use Markdown para formatação")
    descricaoFrontEnd=models.TextField(blank=True, null=True, help_text="Use Markdown para formatação")
